...
const MainLayout = () => {
  ...
  useEffect(() => {
    ...
    if (!token) {
      alert('You must be connected to visit our site....');
      return;
    }
...
<>
      {connectedUser ?(<>
          ...
          <Sider trigger={null} collapsible collapsed={collapsed}>
            <div className="logo">
              <h2 className="text-white fs-5 text-center py-3 mb-0">
                <span id='logo' className="sm-logo">KS</span>
                <span id='logo' className="lg-logo">Koujina Store</span>
              </h2>
            </div>
            <Menu
                theme="dark"
        ...
        <img
            ...
            // width={100%}
            // height={32}
            style={{ height:"500px",width:"80%",marginLeft:"100px",marginTop:"150px",marginRight:""}}
            src="/notfound3.jpg"
            alt=""
        />
        <br/>
        ...
        <div   id="signIn"  style={{marginLeft:"400px",marginRight:"400px"}} onClick={handleSignIn} >Connect </div>
      </>) }
